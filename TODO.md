...
- Program direction: see `research/docs/METTL7-program-direction.md` (methodology first, structural reference set, 7B/7A pocket map, published-ligand recovery, hit reanalysis, perturbation tests, fragment grammar, de novo design, proteome-wide selectivity).
...
- Connected the Report button to the selected pocket and docking run, added an
  evidence-linked pocket report view, and added a downloadable run-scoped PDF.
