...
class OnlineFallbackChemCompProviderTest {
    ...
    void usesReducedEntryWithoutCallingOnlineProvider() {
        ...
        OnlineFallbackChemCompProvider provider = new OnlineFallbackChemCompProvider(
        ...
        ChemComp result = provider.getChemComp("ALA");

        assertSame(localEntry, result);
    ...
    void callsOnlineProviderWhenReducedEntryIsEmpty() {
        ...
        ChemComp result = provider.getChemComp("QWE");

        assertSame(onlineEntry, result);
