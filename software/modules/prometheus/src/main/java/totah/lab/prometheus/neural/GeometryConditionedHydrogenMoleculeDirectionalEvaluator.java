...
public final class GeometryConditionedHydrogenMoleculeDirectionalEvaluator {
    ...
    public record Evaluation(double value,double laplacian,double[] valueDirectionalDerivatives,double[] laplacianDirectionalDerivatives){public Evaluation{valueDirectionalDerivatives=valueDirectionalDerivatives.clone();laplacianDirectionalDerivatives=laplacianDirectionalDerivatives.clone();}@Override public double[] valueDirectionalDerivatives(){return valueDirectionalDerivatives.clone();}@Override public double[] laplacianDirectionalDerivatives(){return laplacianDirectionalDerivatives.clone();}}
}
