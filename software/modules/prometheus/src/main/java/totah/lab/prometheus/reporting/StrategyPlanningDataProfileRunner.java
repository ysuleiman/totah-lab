    ...
    private static List<RequirementRow> qubeRequirements(EvidenceSummary e) {
        return List.of(
                ...
                row("qube-like", "Cartesian Hessian", "PBE-D3(BJ)/def2-SVP at matching minimum", true,
                        "DEVELOPMENT", "REUSE_EXISTING", e.accepted(CalculationType.HESSIAN),
                        "Modified Seminario constants may be DERIVE_FROM_EXISTING",
                        "full Hessians exist for MIN01 MIN02 and MIN04", "bonds;angles"),
    ...
    private static List<RequirementRow> qforceRequirements(EvidenceSummary e) {
        return List.of(
                ...
                row("qforce-like", "Cartesian Hessian", "PBE-D3(BJ)/def2-SVP", true, "DEVELOPMENT",
                        "REUSE_EXISTING", e.accepted(CalculationType.HESSIAN), "project bonded curvature",
                        "three matching Hessians are authoritative", "bonds;angles"),
    ...
    private static List<RequirementRow> forceBalanceRequirements(EvidenceSummary e) {
        return List.of(
                ...
                row("forcebalance-style", "Hessian curvature", "PBE-D3(BJ)/def2-SVP", true,
                        "DEVELOPMENT", "REUSE_EXISTING", e.accepted(CalculationType.HESSIAN),
                        "project or target existing Cartesian Hessians",
                        "three authoritative Hessians provide curvature targets", "curvature targets"),
