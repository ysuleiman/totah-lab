...
import totah.lab.hephaestus.mutation.geometry.SideChainBuilder;
import totah.lab.hephaestus.mutation.geometry.SideChainTemplate;

import java.util.List;
import java.util.Objects;

public final class LocalRotamerOptimizer {
    private final SideChainBuilder builder;
    private final RotamerEvaluator evaluator;

    public LocalRotamerOptimizer() {
        this(new SideChainBuilder(), new RotamerEvaluator());
    }

    public LocalRotamerOptimizer(SideChainBuilder builder, RotamerEvaluator evaluator) {
