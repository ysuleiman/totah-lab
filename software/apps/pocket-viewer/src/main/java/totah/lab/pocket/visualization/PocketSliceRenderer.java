...
public final class PocketSliceRenderer {
    ...
    public BufferedImage renderProjection(
        ...
        List<Residue> residues = residueSelection.resolvedResidues(
                structure, pocket);
        List<AlphaSphere> spheres = alphaSpheres(pocket);
    ...
    private void drawAllAlphaSpheresProjected(
        ...
        for (AlphaSphere sphere : spheres) {
            PocketProjection.ProjectedPoint projected =
                    PocketProjection.project(sphere.center(),
                            plane);
    ...
    private static double sphereRadius(AlphaSphere sphere) {
    ...
    private static List<AlphaSphere> alphaSpheres(Pocket pocket) {
